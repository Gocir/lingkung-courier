...
class DeliverOrders extends StatefulWidget {
  ...
  DeliverOrders({this.courierModel, this.junkSales});
  @override
  _DeliverOrdersState createState() => _DeliverOrdersState();
}
                            ...
                            IntrinsicHeight(
                              child: ButtonBar(
                                ...
                                children: <Widget>[
                                  ...
                                  FlatButton.icon(
                                    icon: FaIcon(FontAwesomeIcons.dumpster,
                                        color: black),
                                    label: CustomText(
                                      text: 'Pesanan',
                                      size: 12.0,
                              ...
                              child: FlatButton(
                                child: Column(
                                  ...
                                  children: <Widget>[
                                    ...
                                    CustomText(text: 'Batalkan', color: grey),
                                  ],
                                ),
                                onPressed: () {
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 16.0),
                  CustomText(
                    text: 'Order ini udah gak bisa di cancel',
                    size: 18.0,
                    weight: FontWeight.w700,
                  ),
                  CustomText(
                    text:
                        'Dikit lagi selesai, kok. Yuk, semangat beresin order biar nambah poin!',
                  ),
                  SizedBox(height: 16.0),
                  Container(
